                ...
                <div class="lg:col-span-1 space-y-6">
                    <div class="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
                        ...
                        <div class="space-y-4 pt-6 border-t border-gray-50">
                            ...
                            <div>
                                <label class="text-[10px] font-black text-gray-400 uppercase tracking-widest">Nama Ibu Kandung</label>
                                <p class="text-gray-900 font-semibold">{{ $registration->mother_name ?? '-' }}</p>
                            </div>

                            <div>
                                <label class="text-[10px] font-black text-gray-400 uppercase tracking-widest">NISN</label>
                                <p class="text-indigo-600 font-bold font-mono text-sm">{{ $registration->nisn ?? '-' }}</p>
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                            @php
                                $files = [
                                    ...
                                    ['label' => 'Akta Kelahiran', 'field' => 'birth_certificate'],
                                    ['label' => 'Ijazah Terakhir', 'field' => 'file_ijazah_sma'],
                                    ['label' => 'Ijazah D3', 'field' => 'file_ijazah_d3'],
                            ...
                            @foreach($files as $file)
                                ...
                                <button onclick="previewFile('{{ asset('storage/' . $registration->{$file['field']}) }}', '{{ $file['label'] }}')" 
                                        class="flex items-center justify-between p-4 border border-gray-100 rounded-2xl hover:bg-indigo-50 hover:border-indigo-200 transition group text-left">
                                    <div class="flex items-center gap-3">
                                        <div class="p-2 bg-gray-50 rounded-lg group-hover:bg-white flex-shrink-0">
